...
#cp .\src\build.json .\src\Acme.recipeBox.WebApi\build.json -force
...
Invoke-Exe -cmd dotnet -args $args
#$args = "publish $PSScriptRoot\src\Acme.recipeBox.WebApi\Acme.recipeBox.WebApi.csproj --no-restore /p:Version=$BuildNumber"
#Invoke-Exe -cmd dotnet -args $args
