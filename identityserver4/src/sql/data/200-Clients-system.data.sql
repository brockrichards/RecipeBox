...
if (not exists(select * from auth.ClientScopes where clientid = @id and scope = 'recipeBox-api'))
  BEGIN
    INSERT [AUTH].[ClientScopes] ([ClientId], [Scope]) VALUES (@id, N'recipeBox-api')
  END
