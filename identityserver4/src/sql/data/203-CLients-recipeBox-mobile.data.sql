  ...
  BEGIN
   -- NOTE WITH PKCE THE REQUIRECLIENTSECRET PARAM MUST BE SET TO 0
	INSERT [AUTH].[Clients] ([AbsoluteRefreshTokenLifetime], [AccessTokenLifetime], [AccessTokenType], [AllowAccessTokensViaBrowser], [AllowOfflineAccess], [AllowPlainTextPkce], [AllowRememberConsent], [AlwaysIncludeUserClaimsInIdToken], [AlwaysSendClientClaims], [AuthorizationCodeLifetime], [BackChannelLogoutSessionRequired], [BackChannelLogoutUri], [ClientClaimsPrefix], [ClientId], [ClientName], [ClientUri], [ConsentLifetime], [Description], [EnableLocalLogin], [Enabled], [FrontChannelLogoutSessionRequired], [FrontChannelLogoutUri], [IdentityTokenLifetime], [IncludeJwtId], [LogoUri], [PairWiseSubjectSalt], [LogoutSessionRequired], [LogoutUri], [NonEditable], [ProtocolType], [RefreshTokenExpiration], [RefreshTokenUsage], [RequireClientSecret], [RequireConsent], [RequirePkce], [SlidingRefreshTokenLifetime], [UpdateAccessTokenClaimsOnRefresh]) 
		VALUES (2592000, 3600, 0, 1, 0, 0, 1, 1, 1, 300, 1, NULL, N'client_', @clientId, N'recipeBox Mobile', NULL, NULL, NULL, 1, 1, 1, NULL, 300, 0, NULL, NULL, 0, NULL, 0, N'oidc', 1, 1, 0, 0, 0, 1296000, 0)
	...
	--Develop environment
	INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://recipeBox.dev.acme.com/logout')
	INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://recipeBox.dev.acme.com')

	--Production environment
	INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://recipeBox.acme.com/logout')
	INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://recipeBox.acme.com')
  END
...
if (exists(select * from auth.Clients where ClientId=@clientId))
  BEGIN
    ...
    set @testPostLogoutRedirectUri = 'https://recipeBox.test.acme.com/logout'
    ...
    set @origin = 'https://recipeBox.test.acme.com'
    ...
    set @productionPostLogoutRedirectUri = 'https://recipeBox.acme.com/logout'
    ...
    set @productionOrigin = 'https://recipeBox.acme.com'
...
insert into @grantedScopes values (N'recipeBox-api')
