...
namespace IdentityServer.WebApi.IntegrationTests.Tests.Admin.User {
    ...
    public class UserTest : IClassFixture<IntegrationTestFixture> {
        ...
        public async Task ShouldCreateUserAsync() {
            ...
            // assert
            response.UserStatus.Should().Be(IdentityServer.WebApi.Models.Enumerations.UserStatus.New);
        }
        ...
        public async Task ShouldUpdateUserAsync() {
            ...
            // update user
            var updateModel = new IdentityServer.WebApi.Models.Input.UpdateUserModel() {
                Username = RandomValues.CreateRandomString(),
                Status = IdentityServer.WebApi.Models.Enumerations.UserStatus.Active,
            ...
            var updateUserRespData = JsonConvert.DeserializeObject<IdentityServer.WebApi.Models.Output.UserOutputModel>(await updateUserResp.Content.ReadAsStringAsync());
            ...
            updateUserRespData.UserStatus.Should().Be(IdentityServer.WebApi.Models.Enumerations.UserStatus.Active);
            ...
            // update password
            var passwordModel = new IdentityServer.WebApi.Models.Input.UpdatePasswordModel() {
                Password = "lessStuff"
            };
        ...
        private IdentityServer.WebApi.Models.Input.CreateUserModel getUserRequestBody() {
            return new IdentityServer.WebApi.Models.Input.CreateUserModel() {
                Username = RandomValues.CreateRandomString(),
        ...
        private async Task<IdentityServer.WebApi.Models.Output.UserOutputModel> CreateUserAsync(IdentityServer.WebApi.Models.Input.CreateUserModel user) {
            integrationTestFixture.Client.DefaultRequestHeaders.Authorization = await GetTokenHeaderAsync();
            ...
            var createUserRespData = JsonConvert.DeserializeObject<IdentityServer.WebApi.Models.Output.UserOutputModel>(content);
