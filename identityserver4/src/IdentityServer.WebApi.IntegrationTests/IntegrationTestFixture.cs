...
using IdentityServer.WebApi.IntegrationTests.Helpers;
...
namespace IdentityServer.WebApi.IntegrationTests {
    public class IntegrationTestFixture : IDisposable {
        ...
        public IntegrationTestFixture() {
            ...
            IWebHostBuilder builder = new WebHostBuilder()
                ...
                .UseStartup<IdentityServer.WebApi.Startup>()
            ...
            IdentityServer.WebApi.Startup.Handler = testserver.CreateHandler();
