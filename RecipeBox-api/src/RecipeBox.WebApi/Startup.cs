...
using RecipeBox.BootStrap;
using RecipeBox.Data;
using RecipeBox.Health;
using RecipeBox.WebApi.Installers;
...
namespace RecipeBox.WebApi {
    ...
    public class Startup : IWebApiStartup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddSwagger(Configuration, "RecipeBox API", "RecipeBox API", ["v1", "v2"]);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IApiVersionDescriptionProvider provider) {
            ...
            app.UseSwagger("RecipeBox Api", provider);
